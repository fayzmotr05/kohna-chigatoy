        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-brown-light/80">
              ...
              <div className="flex items-center gap-2">
                <Truck size={14} className="text-brown-light/50 shrink-0" />
                <span>
                  <span className="text-brown-light/60 mr-1">{t.footer.deliveryPhoneLabel}:</span>
                  {t.footer.deliveryPhone}
                </span>
              </div>
              <div className="flex items-center gap-2">
